...
**第一步** 先确认数据库, 支持 `MySQL,PostgreSQL,MSSQL,SQLite3`

![gitea-db](/img/gitea/gitea-db.png)

为了方便, 我一般选择使用 `SQLite3`

**第二步** 是确认服务器设置

![gitea-service](/img/gitea/gitea-service.png)
...
![gitea-last](/img/gitea/gitea-last.png)
...
![gitea-setting](/img/gitea/gitea-setting.png)

在打开后的页面点击**应用**tab页

![gitea-yy](/img/gitea/gitea-yy.png)

然后填写最下方的 **管理 OAuth2 应用程序**

![gitea-auth](/img/gitea/gitea-auth.png)
...
![gitea-copy](/img/gitea/gitea-copy.png)
