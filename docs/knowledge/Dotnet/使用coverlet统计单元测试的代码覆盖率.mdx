...
![origin](../../../static/img/xunit/origin.png)
...
![cover](../../../static/img/xunit/cover.png)
...
![cover-before](../../../static/img/xunit/cover-before.png)

上图为初始状态

点击这个 Watch 之后会开始解析 `coverage.cobertura.xml`

![cover-after](../../../static/img/xunit/cover-after.png)

之后会显示当前文件覆盖率

![cover-detail](../../../static/img/xunit/cover-detail.png)
